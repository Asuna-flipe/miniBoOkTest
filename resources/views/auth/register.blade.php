                ...
                <div class="card-body">
                    ...
                    {{ csrf_field() }}
                        ...
                        <div class="form-group row">
                            ...
                            <br>
                            <br>
                            <input type="radio" id="gender" class="form-control @error('gender') is-invalid @enderror" name="gender" value="1" @if(old('sex') ==  1) checked="checked" @endif />Female<br>
                            <input type="radio" id="gender" class="form-control @error('gender') is-invalid @enderror" name="gender" value="0" @if(old('sex') ==  0) checked="checked" @endif />Male<br>
